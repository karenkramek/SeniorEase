export const ptBRStrings = {
  ...
  createTask: {
    ...
    titleFieldA11yLabel: "Título da tarefa",
  ...
  taskList: {
    ...
    filterByPrefixA11y: "Filtrar por",
  ...
  taskDetails: {
    ...
    notFoundA11y: "Tarefa não encontrada",
    stepsLabel: "Etapas",
    completeButton: "Marcar tarefa como concluída",
    completeButtonA11y: "Botão para marcar tarefa como concluída",
    ...
    completedTagA11y: "Tarefa concluída",
  },
  profile: {
    title: "Perfil",
    titleA11y: "Título: Perfil",
    fallbackUserName: "Usuário",
    nameA11yPrefix: "Nome",
    emailA11yPrefix: "E-mail",
    logoutButton: "Sair",
  ...
  authRegister: {
    ...
    successBody: "Sua conta foi criada com sucesso. Você será redirecionado para o login.",
